...
common_df_patient <- common_df %>% 
  ...
  select(-c(LLTC, PTC, PTN, PSOCC, ICD, TUTERM, LLTN)) #%>% 
#   rowwise %>% 
...
```{r}
write_csv(common_df_treatment_acute, "acute_dataset.csv")
write_csv(common_df_treatment_chronic, "chronic_dataset.csv")
```
