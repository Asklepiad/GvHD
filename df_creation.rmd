...
ggplot(common_df_patient)+
  ...
  labs(x = "Дата пересадки",
       y = "Количество пересадок",
       title = "Рис. 1 Распределение числа пересадок костного мозга\nза время наблюдения")+
  theme_bw()+
...
#   labs(x = "Возраст пациента",
#        y = "Количество пациентов",
#        title = "Рис. 2 Распределение возраста пациентов")+
#   theme_bw()+
#   theme(axis.text.x = element_text(size=20),
#       axis.text.y = element_text(size=20),
#       axis.title.x = element_text(size=25),
...
ggplot()+
  ...
  scale_x_discrete(name = "Наличие рецидива", labels = c("Нет рецидива", "Нет данных", "Рецидив"))+
  scale_fill_discrete(name = "Выжил ли пациент", labels = c("Выжил", "Не выжил"))+
  labs(y = "Доля",
       title = "Доля выживших больных острой формой РТПХ\nв зависимости от факта наличия рецидива")+
    theme_bw()+
...
ggplot()+
  ...
  scale_fill_discrete(name = "Выжил ли пациент", labels = c("Выжил", "Не выжил"))+
  labs(y = "Доля",
       title = "Доля выживших больных хронической формой РТПХ\nв зависимости от факта наличия рецидива")+
    theme_bw()+
    theme(axis.text.x = element_text(size=30),
          axis.text.y = element_text(size=30),
          axis.title.x = element_text(size=35),
...
ggplot()+
  ...
  scale_x_discrete(name = "Тип донора")+
  scale_fill_discrete(name = "Выжил ли пациент", labels = c("Выжил", "Не выжил"))+
  labs(y = "Доля",
...
ggplot()+
  ...
  scale_x_discrete(name = "Тяжесть состояния в момент\nпостановки диагноза")+
  scale_fill_discrete(name = "Выжил ли пациент", labels = c("Выжил", "Не выжил"))+
  labs(y = "Доля",
       title = "Доля выживших больных острой формой РТПХ\nв зависимости от тяжести исходного состояния")+
    theme_bw()+
    theme(axis.text.x = element_text(size=30),
          axis.text.y = element_text(size=30),
          axis.title.x = element_text(size=35),
...
ggplot()+
  ...
  scale_x_discrete(name = "Степень тяжести поражения ЖКТ\nв момент постановки диагноза")+
  scale_fill_discrete(name = "Выжил ли пациент", labels = c("Выжил", "Не выжил"))+
  labs(y = "Доля",
       title = "Доля выживших больных хронической формой РТПХ\nв зависимости от тяжести поражения ЖКТ")+
    theme_bw()+
    theme(axis.text.x = element_text(size=30),
          axis.text.y = element_text(size=30),
          axis.title.x = element_text(size=35),
...
ggplot()+
  ...
  scale_x_discrete(name = "Выжил ли пациент")+
  scale_fill_discrete(name = "Факт развития резистентности", labels = c("Нет резистентности", "Есть резистентность"))+
  labs(y = "Доля",
       title = "Доля пациентов с развивишейся резистентностью к ГКС\nв подгруппах выживыших и невыживших пациентов")+
    theme_bw()+
    theme(axis.text.x = element_text(size=30),
          axis.text.y = element_text(size=30),
          axis.title.x = element_text(size=35),
...
ggplot()+
  ...
  scale_x_discrete(name = "Степень тяжести состояния пациента\nв момент постановки даигноза")+
  scale_fill_discrete(name = "Факт развития резистентности", labels = c("Нет резистентности", "Есть резистентность"))+
  labs(y = "Доля",
